<?php
    ...
    if (isset($_POST['add_room'])) {
        ...
        if ($stmt = mysqli_prepare($conn, $q2)) {
            ...
            $flag = 0;
            die('querry cannot be prepared in insert statement!');
        }
        ...
        while ($row = mysqli_fetch_assoc($res)) {
            ...
            $data .= "
                    <tr class='align-middle'>
                        ...
                        <td>$status</td>
                        <td>
                            <button type='button' onclick=\"room_images($row[id],'$row[name]')\" class='btn custom-bg text-dark fw-bold shadow-none mb-1 ' data-bs-toggle='modal' data-bs-target='#room-images'>
                                <i class='bi bi-images'></i> 
                            </button>
                            <button type='button' onclick='edit_details($row[id])' class='btn btn-danger shadow-none btn-sm mb-1' data-bs-toggle='modal' data-bs-target='#edit-room'>
